...
class TelegramSummaryBot:
    ...
    - Для выполненных поручений указывай детализацию, укажи имена топик и тд, не пиши общо
    - Если не уверен по статусам поручений лучше не указывай их
    ...
    Избегай общих слов и воды, будь конкретен и краток.
    """
    ...
    4. Структура:
    [Общая статистика за неделю] - самое главное очень кратко
    [Выполненные поручения]
    [Текущие поручения]
